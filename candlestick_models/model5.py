...
18293/18293 [==============================] - 7716s 422ms/step - loss: 0.6159 - accuracy: 0.5656 - val_loss: 0.5986 - val_accuracy: 0.7082
...
X = core.tf.keras.layers.Conv2D(filters=512*filters_mult, kernel_size=3, strides=(1,1), padding='same')(X)
X = core.tf.keras.layers.Conv2D(filters=512*filters_mult, kernel_size=3, strides=(1,1), padding='same')(X)
X = core.tf.keras.layers.BatchNormalization()(X)
X = core.tf.keras.layers.Activation('relu')(X)
X = core.tf.keras.layers.MaxPool2D(pool_size=(2,2))(X)

...
18293/18293 [==============================] - 1494s 82ms/step - loss: 0.6145 - accuracy: 0.5577 - val_loss: 0.6024 - val_accuracy: 0.5634
...
# X = core.tf.keras.layers.Conv2D(filters=256*filters_mult, kernel_size=3, strides=(1,1), padding='same')(X)
# X = core.tf.keras.layers.Conv2D(filters=256*filters_mult, kernel_size=3, strides=(1,1), padding='same')(X)
# X = core.tf.keras.layers.BatchNormalization()(X)
# X = core.tf.keras.layers.Activation('relu')(X)
# X = core.tf.keras.layers.MaxPool2D(pool_size=(3,3))(X)
